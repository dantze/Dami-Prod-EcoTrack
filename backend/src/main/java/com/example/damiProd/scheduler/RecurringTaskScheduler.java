...
/**
 * Tops up tasks for active, indefinite recurring plans.
 *
 * Invoked once a night by the {@code generate-tasks} Cloud Run Job, through
 * {@link com.example.damiProd.job.JobRunner} — the schedule lives in Cloud
 * Scheduler, not in an annotation here (TODO-80).
 */
@Component
